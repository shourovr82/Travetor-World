      ...
      <footer aria-label="Site Footer" className="bg-blue-50">
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          >
            ...
            <a
              className="inline-flex items-center rounded-full border border-white bg-white px-8 py-3 text-indigo-600 hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
              href="/"
            >
